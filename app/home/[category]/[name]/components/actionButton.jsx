    ...
    <>
      {stock && !isInCart && (
        <button
          ...
          className="z-20 bg-blue-800 text-sm hover:bg-blue-900 disabled:bg-gray-400 disabled:text-black disabled:opacity-80 disabled:cursor-not-allowed transition-all text-white px-2 py-1 rounded-md shadow-black shadow"
        >
          {label}
        </button>
      )}
      {stock && isInCart && (
        <button
          ...
          className="z-20 text-sm bg-red-800 hover:bg-red-900 text-white opacity-80 transition-all px-2 py-1 rounded-md shadow-black shadow"
        >
          {label}
        </button>
      )}
